# -*- coding: utf-8 -*-
"""
Created on Wed Nov  2 19:20:38 2016
...
def plot_contour(x_contour,y_contour,x_colour,y_colour): 
    ...
    ax.contourf(rxbins, rybins, uvals.T, 20, zorder=10)
...
array = np.load('/home/calum/Documents/MPhysProj/data/vespa_data/vespa_SMF_sfr_separated.npy')
...
#plt.figure() 
#plt.ylim(0,10000) 
#plt.xlim(0,0.1*pow(10,13))       
#plt.hist(data, bins =1000) 

#        # kcorrect
#        kcorrection_array, z = get_kcorrections(row[1:13])
...
#
## vespa contour
#np.save('/home/calum/Documents/MPhysProj/data/vespa_SMF_sfr_separated_contour.npy',reduced_array)                
#
## vespa contour
#reduced_array = np.load('/home/calum/Documents/MPhysProj/data/vespa_SMF_sfr_separated_contour.npy')
## full contour                
...
#y = array[1]
#
#reduced_x = reduced_array[0]
#reduced_y = reduced_array[1]
#
#plot_contour(x,y,reduced_x,reduced_y)
