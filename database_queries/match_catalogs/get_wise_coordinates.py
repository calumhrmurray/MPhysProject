...
# Execute the Query
sql_string = 'SELECT ra, dec FROM WISE..wise_allskysc; ' 
...
if os.path.exists('/home/cmurray/data/wise_coords.fits'):
    os.remove('/home/cmurray/data/wise_coords.fits')
...
tbhdu.writeto('/home/cmurray/data/wise_coords.fits')
